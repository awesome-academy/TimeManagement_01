...
import pomobox.ui.break_tasks.fragment.BreakTasksFragment;
...
import static pomobox.utils.Constants.OPTION_BREAK_TASKS;
...
public class MainActivity extends AppCompatActivity
    ...
    private void selectItem(int position) {
        ...
        switch (i) {
            ...
            case OPTION_BREAK_TASKS:
                fragment = BreakTasksFragment.newInstance();
                break;
