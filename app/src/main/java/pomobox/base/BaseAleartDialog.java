...
public abstract class BaseAleartDialog extends AlertDialog.Builder{

    private Context mContext;
    private String mTitle, mMessage, mTextNegative, mTextPositive;
    private int mIcon;

    protected BaseAleartDialog(@NonNull Context context, String title, String message, String textNegative, String textPositive, int icon) {
        super(context);
        mContext = context;
        mTitle = title;
        mMessage = message;
